...
In terminal, run npm install, then run "node server.js".

## Data:
Statistics are from https://www.pro-football-reference.com. As I have no API to access,
I have to manually update this.

## 3 Tasks the user can do
